                ...
                <div class="card-body">
                  ...
                  <form method="POST"action="{{route('mahasiswa.update', $mahasiswa["id"])}}" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="npm" value="{{old('npm') ? old('npm') : $mahasiswa["npm"]}}" placeholder="Nomor pokok" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      class="form-control">
                            @foreach($prodi as $item)
                                ...
                                ($mahasiswa['prodi_id']==$item["id"] ? "selected" : null)}}>
                                    {{ $item['nama']}}
                                </option>
                            @endforeach
                      </select>
